...
10. **Décisions** : GP/GC purgées des phases obligatoires (testeurs = optionnels via @agent-factory, conforme décision S4) ; SOT prompts = index.html (91 après cure prompts).
