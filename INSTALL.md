...
```bash
curl -fsSL https://raw.githubusercontent.com/thomasissa-png/Agent-Team/master/update.sh -o update.sh && chmod +x update.sh
```
...
>
> 1. `git clone https://github.com/thomasissa-png/Agent-Team -b master /tmp/Agent-Team 2>/dev/null || (cd /tmp/Agent-Team && git pull origin master)`
...
git clone https://github.com/thomasissa-png/Agent-Team -b master /tmp/Agent-Team 2>/dev/null || \
